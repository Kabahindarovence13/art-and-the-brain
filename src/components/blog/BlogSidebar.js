...
export default function BlogSidebar() {
    ...
    const catagoryItems = [
        {
            name: "Art history and femminism",
            count: 9
        },
        {
        ...
        {
            name: "Behavioral ethics",
            count: 8
        },
        {
            name: "Multimeda communication",
            count: 13
        },
        {
            name: "Sexuality and HIV AIDS",
            count: 4
        }
    ].map((ele, index) => (
        <li key={index}>
    ...
    return(
        <div className="blog-sidebar-area">
            ...
            {/* Widget Area */}
            <div className="single-widget-area mb-4 mb-lg-5">
                <h4 className="widget-title mb-30">Articles</h4>
